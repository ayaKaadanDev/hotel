  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-4 mt-5 bg-light rounded">
        <h1 class="text-center font-weight-bold text-primary h3 p-3">creat a new employee</h1>
        <hr class="bg-light">
        ...
        <form action="{{route('employees.store')}}" method="POST" >
          ...
          <select name="nationality" class="form-control" placeholder="Enter the nationality" required>
          ...
          <div class="form-group input-group">
            ...
            <select name="profassion" class="form-control" placeholder="Enter the profassion" required>
                <option value="">-- select the type of jop --</option>
          ...
          <input type="text" name="arrive_from" class="form-control" placeholder="Enter the arrive from" required>
        </div>
        <div class="form-group input-group">
            <div class="input-group-prepend">
                <span class="input-group-text"><label for="date_of_arrive">date of arrive</label></span>
            </div>
            <input type="date" name="date_of_arrive" class="form-control" placeholder="Enter the date of arrive" required>
        </div>
          <div class="form-group input-group">
            {{-- <div class="input-group-prepend">
              <span class="input-group-text"><label for="date_of_depart">date of depart</label></span>
            </div>
            <input type="date" name="date_of_depart" class="form-control" placeholder="Enter the date of depart" required>
          </div> --}}
          ...
          <div class="form-group input-group">
            ...
            <input type="number" name="phone_number" class="form-control" placeholder="Enter the phone number" required>
          </div>

          <div class="form-group input-group">
            <div class="input-group-prepend">
              <span class="input-group-text"><label for="word_hours">work hours</label></span>
            </div>
            <input type="number" name="word_hours" class="form-control" placeholder="Enter the word hours" required>
        </div>

  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-4 mt-5 bg-light rounded">
        <h1 class="text-center font-weight-bold text-primary h3 p-3">creat a new secutiry card</h1>
        <hr class="bg-light">
        <h5 class="text-center text-success"></h5>
        <form action="{{route('securitycards.store')}}" method="POST" >
            @csrf
        ...
        <div class="form-group input-group">
          ...
          {{-- <div class="form-group input-group">
            <div class="input-group-prepend">
              <span class="input-group-text"><label for="room_id">bed's number</label></span>
            </div>
            <select name="room_id" id="room_id">
                @foreach ($room as $r)
                    <option value="{{$r->id}}">{{$r->beds_number}}</option>
                @endforeach
            </select>
          </div> --}}

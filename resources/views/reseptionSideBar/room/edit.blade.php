      ...
      <div class="col-md-4 mt-5 bg-light rounded">
        ...
        <form action="{{route('rooms.update',$room->id)}}" method="POST" >
          ...
          <div class="form-group input-group">
            ...
            <input type="number" name="number" class="form-control" value="{{$room->number}}" placeholder="Enter the number" readonly required>
          </div>
          <div class="form-group input-group">
            <div class="input-group-prepend">
              <span class="input-group-text"><label for="floor">floor</label></span>
            </div>
            <input type="number" name="floor" class="form-control" value="{{$room->floor}}" placeholder="Enter the floor" readonly required>
          </div>
          <div class="form-group input-group">
            <div class="input-group-prepend">
              <span class="input-group-text"><label for="beds_number">beds number</label></span>
            </div>
            <input type="number" name="beds_number" class="form-control" value="{{$room->beds_number}}" placeholder="Enter the beds number" readonly required>
          </div>
          <div class="form-group input-group">
            <div class="input-group-prepend">
